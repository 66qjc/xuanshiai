...
_PERSONAL_FIELD_GUIDE = {
    "age": "整数，年龄，范围 18-100",
    "city_code": "字符串，6 位行政区划代码，如 330100",
    "marriage_status": "枚举，取值 single / divorced / widowed",
    "education_level": "整数，学历等级，1-8（1=初中及以下 … 8=博士）",
    "height_cm": "整数，身高厘米数，范围 100-250",
    "income_band": "整数，收入档位，0 及以上",
...
_IDEAL_PARTNER_FIELD_GUIDE = {
    ...
    "education_level": "区间，{\"min\": 最低学历, \"max\": 最高学历}，1-8；max 可为 null",
    "height_cm": "区间，{\"min\": 最矮, \"max\": 最高}，100-250",
    "income_band": "区间，{\"min\": 最低档位, \"max\": 最高档位}，0 及以上；max 可为 null",
